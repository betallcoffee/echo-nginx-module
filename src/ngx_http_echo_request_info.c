...
ngx_int_t
ngx_http_echo_request_headers_variable(ngx_http_request_t *r,
        ngx_http_variable_value_t *v, uintptr_t data)
{
    size_t                      size;
    u_char                      *p, *last;
 ...
 * Copyrighted (C) by Igor Sysoev */
ngx_int_t
ngx_http_echo_client_request_body_variable(ngx_http_request_t *r,
        ngx_http_variable_value_t *v, uintptr_t data)
{
    u_char       *p;
    size_t        len;
    ...
    if (r != r->main) {
        request_body = r->main->request_body;
    } else {
